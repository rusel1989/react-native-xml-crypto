...
SignedXml.prototype.computeSignature = function(xml, opts) {
  ...
  if (opts.async) {
    return this.createSignatureAsync(signedInfo, prefix)
    .then((sig) => {
      this.signatureXml += sig
...
SignedXml.prototype.insertSignature = (doc, location) => {
...
SignedXml.prototype.createSignatureAsync = (signedInfo, prefix) => {
  var xmlNsAttr = 'xmlns'
